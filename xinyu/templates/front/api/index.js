...
export const recoveryPassword = (tableName, data) => {
	return http.request({
		url: `${tableName}/recovery`,
		method: 'POST',
		data
	});
}
export const examProgress = (data) => {
	return http.request({
		url: `examrecord/progress`,
		method: 'GET',
		data
	});
}
...
export const submitExam = (data) => {
	return http.request({
		url: `examrecord/submit`,
		method: 'POST',
		data
	});
}
export const examResult = (data) => {
	return http.request({
		url: `examrecord/result`,
		method: 'GET',
		data
	});
}
